...
//Mock é um dado ficticio
class Mock {
    private val sunny = Constants.FILTER.SUNNY
    private val all = Constants.FILTER.ALL
    private val happy = Constants.FILTER.HAPPY_FACE

    private val pt = Constants.LANGUAGE.PORTUGUESE
    private val en = Constants.LANGUAGE.ENGLISH
    private val fr = Constants.LANGUAGE.FRANCH
    ...
    fun getPhrase(value: Int, lang: String): String {
        val filtered =
            mListPhrase.filter { (it.categoryId == value || value == all) && it.lang == lang }
